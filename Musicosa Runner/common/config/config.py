...
from common.config.defaults import DEFAULT_ARTIFACTS_FOLDER, DEFAULT_START_FROM_STAGE, \
    DEFAULT_STITCH_FINAL_VIDEO_FLAG, DEFAULT_FORMS_FOLDER, DEFAULT_VALID_TITLES_FILE, DEFAULT_TEMPLATES_API_URL, \
    ...
    DEFAULT_OVERWRITE_VIDEO_BITS, DEFAULT_FINAL_VIDEO_NAME, DEFAULT_PRESENTATION_DURATION, DEFAULT_TRANSITION_DURATION, \
    DEFAULT_TRANSITION_TYPE, DEFAULT_STAGE_6_QUIET_FFMPEG, DEFAULT_QUIET_FFMPEG_FINAL_VIDEO
from common.custom_types import Stage
from config.defaults import DEFAULT_CONTESTANT_NAME_COORDS, DEFAULT_ENTRIES_DATA_COORDS
...
class StageOneConfig:
    forms_folder: str = DEFAULT_FORMS_FOLDER
