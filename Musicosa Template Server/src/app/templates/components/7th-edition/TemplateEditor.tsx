...
import { defaultEditionProps } from '@/app/templates/components/Template/7th-edition/defaults'
import { Template, TemplateProps } from '@/app/templates/components/Template/7th-edition/Template'
import { defaultResolvedAuthor } from '@/app/templates/common/withTemplateProps/defaults'
    ...
    const contestants = [
        ...
        },
        {
            ...
            avatar: {
                ...avatarDefaults,
                id: 5,
                resolvedImageFilename: 'Jorge.png',
                imageHeight: 647
            },
            scoring: { ...scoringTemplate }
        },
